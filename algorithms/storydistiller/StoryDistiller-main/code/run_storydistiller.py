...
if 'Linux' in env_os: # Ubuntu
    ...
    sdk_platform_path = '/home/StoryDistiller-main/main-folder/config/libs/android-platforms/'
    lib_home_path = '/home/StoryDistiller-main/main-folder/config/libs/'
    callbacks_path = '/home/StoryDistiller-main/main-folder/config/AndroidCallbacks.txt'
    jadx_path = '/home/StoryDistiller-main/jadx-master/'
    ic3_path = '/home/StoryDistiller-main/IC3/'
...
if __name__ == '__main__':
    ...
    # restore main folder
    os.system('rm -r /home/StoryDistiller-main/main-folder/*')
    os.system('cp -r /home/StoryDistiller-main/main-folder-copy/. /home/StoryDistiller-main/main-folder/')
    ...
    if sys.argv[2] is not None:
        os.system('cp %s %s' % (sys.argv[2], apk_dir))
    ...
    for apk in os.listdir(apk_dir):
        if apk.endswith('.apk'):
            ...
            # copy output to new folder
            if sys.argv[3] is not None:
                os.system('cp -r %s. %s' % (result_apkfolder, sys.argv[3]))